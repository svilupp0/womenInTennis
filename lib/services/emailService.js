...
export async function sendVerificationEmail(email, token, userName = '') {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM || `"Women in Tennis" <${process.env.EMAIL_USER}>`,
      to: email,
      subject: '🎾 Verifica la tua email - Women in Tennis',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Grazie per esserti registrata su <strong>Women in Tennis</strong>!</p>
            ...
            <div class="footer">
              ...
              <p>© 2024 Women in Tennis - Community di tennis femminile</p>
            </div>
          </div>
        </body>
        </html>
      `,
      text: `
        🎾 Women in Tennis - Verifica Email
        
        Ciao${userName ? ` ${userName}` : ''}!
        
        Grazie per esserti registrata su Women in Tennis!
...
export async function sendWelcomeEmail(email, userName = '') {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM || `"Women in Tennis" <${process.env.EMAIL_USER}>`,
      to: email,
      subject: '🎉 Benvenuta in Women in Tennis!',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <h2>Benvenuta${userName ? ` ${userName}` : ''}! 🎉</h2>
      ...
      `,
      text: `
        🎾 Women in Tennis - Benvenuta!
        
        Benvenuta${userName ? ` ${userName}` : ''}!
...
export async function sendResetPasswordEmail(email, token) {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM || `"Women in Tennis" <${process.env.EMAIL_USER}>`,
      to: email,
      subject: '🔐 Reset Password - Women in Tennis',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Hai richiesto di reimpostare la password per il tuo account Women in Tennis.</p>
      ...
      `,
      text: `
        🔐 Women in Tennis - Reset Password

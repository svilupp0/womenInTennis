...
export const ERROR_MESSAGES = {
  ...
  EMAIL_NOT_VERIFIED:
    'Email non verificata. Controlla la tua casella di posta o richiedi un nuovo link di verifica.',
  ...
  EMAIL_EXISTS_VERIFIED:
    'Un utente con questa email esiste già ed è verificato. Prova a fare login.',
  EMAIL_EXISTS_UNVERIFIED:
    'Un utente con questa email esiste già ma non è verificato. Controlla la tua email o richiedi un nuovo link di verifica.',
